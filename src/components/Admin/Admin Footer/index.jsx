...
export default function AdminFooter() {
    return (
        <Container>
            <div className='py-5 flex justify-between items-center gap-2.5 flex-col sm:flex-row'>
                <img src="https://preview.colorlib.com/theme/florist/img/logo.png.webp" alt="logo" />
                <p className='m-0'>The floristry business has a significant market in the corporate and social event world, as flowers</p>
                <div className='links flex items-center justify-center gap-2 flex'>
            ...
            <div className='grid grid-cols-1 border-y border-grey border-solid md:grid-cols-2 lg:grid-cols-3'>
                ...
                <div className='p-5 border-x border-solid border-grey flex flex-col gap-2.5'>
                    <h3>Newletter</h3>
                    <span>Subcribe to our newsletter to get more free tips. No Spam, Promise.</span>
                    <div className='border-b-2 border-black border-solid flex py-1'>
            ...
            <div className="text-center py-4 text-lg">
                Copyright ©2025 All rights reserved | This template is made with ❤️ by <span className="text-[#f45d96]">Colorlib</span>
            </div>
        </Container>
    )
}